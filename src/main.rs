    ...
    match part {
        ...
        _ => {
            match day {
                ...
                18 => println!("{}", day18::solution2(reader).unwrap()),
                ...
                23 => println!("{}", day23::solution2(reader).unwrap()),
                24 => println!("{}", day24::solution2(reader).unwrap()),
                25 => println!("{}", day24::solution2(reader).unwrap()),
                _ => println!("What?"),
            };
        }
    };
